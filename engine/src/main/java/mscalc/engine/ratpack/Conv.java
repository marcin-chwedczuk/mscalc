...
import static mscalc.engine.WinErrorCrossPlatform.SUCCEEDED;
...
public interface Conv {
    ...
    static void ratpowi32(Ptr<RAT> proot, int power, int precision)
    {
        ...
        else
        {
            ...
            while (power > 0)
            {
                ...
                Rat.mulrat(proot, proot.deref(), precision);
                           ...
                           uint radix, int precision)
    {
        ...
        if (exponentIsNegative)
        {
            ...
            Rat.divrat(resultRat, pratexp, precision);
        }
        else if (expt > 0)
        {
            // multiplier is greater than 1, this means multiply.
            Rat.mulrat(resultRat, pratexp, precision);
        }
